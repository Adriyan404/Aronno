...
class Main:
	def __init__(self):
		...
		if Baloch in ["", " "]:
			...
			time.sleep(3.0)
			os.system("clear")
        print(" \033[1;37m[1] FILE Cloning ("Coming Soon")
		print(" \033[1;37m[1] CRACK PUBLICK ID")
		print(" \33[1;37m[2]PAK ID CLONING")
		print(" \033[1;37m[3] 2004 TO 2010[Just Now]")
		print(" \33[1;37m[4] 2011 TO 2019 ")
